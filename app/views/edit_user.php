            ...
            <div class="max-w-4xl mx-auto">
                <?php if (empty($user)): ?>
                    <div class="glass-panel p-8 text-center">
                        ...
                        <h2 class="text-2xl font-playfair font-bold text-slate-800 mb-4">Nie znaleziono użytkownika</h2>
                        <p class="text-slate-600 text-lg mb-6">Sprawdź poprawność identyfikatora i spróbuj ponownie.</p>
                        <a href="index.php?action=admin_dashboard" class="px-6 py-3 border border-slate-300 text-slate-700 rounded-xl hover:bg-slate-50 transition-all duration-300 font-semibold">
                            Wróć do panelu
                        </a>
                    </div>
                <?php else: ?>
