    ...
    <main class="container mx-auto px-4 py-8">
        ...
        ?>
            <div class="bg-white rounded-xl shadow-card p-8 text-center">
                ...
                <h2 class="text-2xl font-bold text-dark-blue mb-2">Offer not found</h2>
                <p class="text-secondary-500 mb-6">The requested property listing does not exist or has been removed.</p>
                ...
                <ol class="inline-flex items-center space-x-1 md:space-x-3">
                    ...
                    <li>
                        <div class="flex items-center">
                            ...
                            <a href="index.php?action=search" class="ml-1 text-sm font-medium text-secondary-500 hover:text-dark-blue md:ml-2">Browse Properties</a>
                        </div>
                    </li>
